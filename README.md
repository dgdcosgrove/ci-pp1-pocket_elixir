...
![Responsice Mockup](./assets/images/responsive-image.PNG)
...
- __The landing page image__
  ...
  - The landing page includes a photograph with text overlay and a call to action grab the user's attention and allow them to access information (reason for visit).
  - This section introduces the user to Pocket Elixir leaving no doubt as to what the site is about.
